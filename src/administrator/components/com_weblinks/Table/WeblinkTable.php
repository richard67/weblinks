...
class WeblinkTable extends \JTable
{
	 ...
	 * On Joomla version below 4.0 this is set to false in the contructor.
	 *
	 * @var    boolean
	 * @since  4.0.0
	 */
	...
	public function store($updateNulls = false)
	{
		...
		$useNull = $updateNulls && $this->_supportNullValue;
		...
		// Set publish_up to null value or preudo null date if not set
		if (!$this->publish_up)
		{
			$this->publish_up = $useNull ? null : $this->getDbo()->getNullDate();
		}

		// Set publish_down to null value or preudo null date if not set
		if (!$this->publish_down)
		{
			$this->publish_down = $useNull ? null : $this->getDbo()->getNullDate();
		}
	...
	public function check()
	{
		...
		if ($this->publish_up !== null && $this->publish_down !== null && $this->publish_down > $db->getNullDate() && $this->publish_down < $this->publish_up)
		{
